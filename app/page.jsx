    ...
    <a href={resume} download={resume} target="_blank" rel="noopener noreferrer">
        Download CV
          ...
          <div className='text-center p-10'>
            ...
            <h3 className='text-2xl py-2 md:text-3xl text-pribg font-semibold'>Not Your Regular Developer</h3>
            <p className='text-xl font-semibold py-5 leading-8 text-pribg md:text-xl max-w-xl mx-auto'>Freelancer providing services for programming and design content
        ...
        <section>
          <div>
            ...
            <p className='text-2xl py-2 leading-8 text-pribg font-semibold'>
            ...
            <p className="text-pribg text-2xl font-semibold py-2 leading-8">
          ...
          <div className="text-xl font-semibold text-center p-10 rounded-xl my-10 dark:bg-white border border-sectxt shadow-[-7px_7px_0px_#FFD739] transform transition duration-300 hover:scale-110 hover:bg-secbg hover:border-2 hover:border-sectxt hover:text-pritxt">
        ...
        <section>
          <div>
            <h3 className='text-3xl font-semibold py-1'>Portfolio</h3>
            <p className="text-2xl font-semibold py-2 leading-8 text-pribg">
              Since the beginning of my journey as a freelance designer and
              developer, I've done remote work for
              <span className="text-secbg"> agencies </span>
              consulted for <span className="text-secbg">startups </span>
            ...
            <p className="text-2xl font-semibold py-2 leading-8 text-secbg ">
              I offer from a wide range of services, including brand design,
              programming and teaching.
            </p>
          </div>
